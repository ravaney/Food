...
public class activity3 extends AppCompatActivity {
    ...
    private int[] imgs ={R.drawable.bcb,R.drawable.las,R.drawable.macncheese,R.drawable.jcc,R.drawable.icb,R.drawable.chai,R.drawable.liit} ;
    ...
    private String[] recipes ={"Ingredients \n" +
    ...
    public void randomise(){
        ...
        img.setImageResource(imgs[random]);
